...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Abdullah200020500\PycharmProjects\lexicalAnalyzer\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Abdullah200020500\PycharmProjects\lexicalAnalyzer\venv\Scripts\deactivate.nu'
